...
class DeepGPLayer(ApproximateGP):
    ...
    def __init__(self, variational_strategy, input_dims, output_dims,is_last_layer,jitter=1e-6):
    ...
    def __call__(self, inputs, are_samples=False, **kwargs):
        ...
        if (self.output_dims is not None) and (self.is_last_layer==False):
